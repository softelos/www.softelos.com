...
description: "This is and article that describes the process that we follow to create a website. Softelos is a Web Design and Development Agency located in Lynchburg (VA)."
...
This wire frame structure is like the framing of a house. It's functional, it allows the client to get an idea and make comments in case a room should be reallocated or more doors should be added on the wall. In the case of a website, the same principle applies, our customer will be able to test how all pages are connected, how all the blocks of information are structured, the size of the design, the contact forms, etc..
...
During this stage we communicate with our customer to discuss the initial visual concept and refine based on their feedback. Adding extra touches here and there just enhances the design for perfection. We usually allows two or three iterations of changes before closing the design.
